...
Purpose: MMVPianoRollVectorial object for MIDI visualization
...
class MMVPianoRollVectorial:
    ...
    def __init__(self, mmv, **kwargs) -> None:
        ...
        debug_prefix = "[MMVPianoRollVectorial.__init__]"
        ...
        if self.config["type"] == "top-down":
            ...
            raise RuntimeError("No matching MMVPianoRollVectorial type, kwargs:", kwargs)
        ...
        if self.config["type"] == "top-down":
            print(debug_prefix, "Piano roll class is MMVPianoRollTopDown")
            self.builder = MMVPianoRollTopDown(self.mmv, self)
