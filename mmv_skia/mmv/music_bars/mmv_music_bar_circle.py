...
Purpose: MMVMusicBarsCircle object
...
class MMVMusicBarsCircle:
    ...
    def __init__(self, mmv, MMVVectorial, **kwargs):
        debug_prefix = "[MMVMusicBarsCircle.__init__]"
        self.mmv = mmv
    ...
    def build(self, fitted_ffts: dict, frequencies: list, config: dict, effects):
        debug_prefix = "[MMVMusicBarsCircle.build]"
