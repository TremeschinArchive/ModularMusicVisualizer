...
class MMVSkiaPianoRollVectorial:
        ...
        For MMVSkiaPianoRollTopDown:
            {
                ...
                "piano_key_follows_note_color": bool, True
                    The playing note gets a similar colors to the note being played?
            }
    ...
    def __init__(self, mmv, **kwargs) -> None:
        ...
        if self.config["type"] == "top-down":
            ...
            self.config["piano_key_follows_note_color"] = kwargs.get("piano_key_follows_note_color", True)
