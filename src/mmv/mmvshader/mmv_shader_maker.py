...
class MMVShaderMaker:
    ...
    def load_shader_from_path(self, path: Path, replaces = {}, get_name_from_file = True):
        ...
        # Assign data to fragment shader, add prefix
        self._fragment_shader = f"{SHADERMAKER_PREFIX}{data}"
    ...
    def __replace_progressive(self, marker: str, data: str, indent: str):
        ...
        self._fragment_shader = self._fragment_shader.replace(f"{indent}{marker}", f"{data}{indent}{marker}", 1)
