...
class PolarCoordinates:
    ...
    def from_r_theta(self, r: Number, theta: Number) -> None:
        self.r = r
        self.theta = theta
    
    def from_rectangular(self, x: Number, y: Number) -> None:
        self.r, self.theta = self.rectangular_to_polar(x, y)

    def polar_to_rectangular(self, r: Number, theta: Number) -> list:
        # x = r.cos(theta)
        # y = r.sin(theta)
        x = r * math.cos(theta)
        y = r * math.sin(theta)
    ...
    def rectangular_to_polar(self, x: Number, y: Number) -> list:
