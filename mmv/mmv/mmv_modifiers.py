...
kwargs: {
    ...
    "mode": see return_by_mode and ModifierMode
}
"""
class MMVModifierLine:
    ...
    def __init__(self, mmv, **kwargs) -> None:
        ...
        self.mode = kwargs.get("mode", ModifierMode.OVERRIDE_VALUE_KEEP_OFFSET_VALUE)
...
class MMVModifierShake:
    ...
    def __init__(self, mmv, **kwargs) -> None:
        ...
        self.mode = kwargs.get("mode", ModifierMode.OFFSET_VALUE)
...
class MMVModifierVignetting:
    def __init__(self, mmv, **kwargs) -> None:
        ...
        self.center_function_x = kwargs.get("center_x", 
            MMVModifierConstant(self.mmv, value = self.mmv.context.width // 2)
        )
        self.center_function_y = kwargs.get("center_x", 
            MMVModifierConstant(self.mmv, value = self.mmv.context.height // 2)
        )
