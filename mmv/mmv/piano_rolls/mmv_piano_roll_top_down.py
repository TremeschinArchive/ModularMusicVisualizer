...
class MMVPianoRollTopDown:
    def __init__(self, mmv, MMVPianoRollVectorial):
        self.mmv = mmv
        self.vectorial = MMVPianoRollVectorial
    ...
    def generate_piano(self, min_note, max_note):
        ...
        debug_prefix = "[MMVPianoRollTopDown.generate_piano]"
...
class PianoKey:
    def __init__(self, mmv, vectorial, MMVPianoRollTopDown):
        self.mmv = mmv
        self.vectorial = vectorial
        self.piano_roll = MMVPianoRollTopDown
